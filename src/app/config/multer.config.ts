...
const storage = new CloudinaryStorage({
    ...
    params: {
        public_id: (req, file) =>{
            ...
            .toLowerCase()
            .replace(/\s+/g, "_")  // empty space remove replace with dash
            .replace(/\./g, "_")  // empty dot remove replace with dash
            ...
            const uniqueFileName = Math.random().toString(36).substring(2) + "-" + fileName + "." + extention
